...
echo mkdir /release/eview-server/win64-vs2013 >> _upload.ftp
echo mkdir /release/eview-server/win64-vs2013/backup >> _upload.ftp
echo cd /release/eview-server/win64-vs2013 >> _upload.ftp
echo mput eview-server-commondriver.rar  >> _upload.ftp

echo cd /release/eview-server/win64-vs2013/backup >> _upload.ftp
